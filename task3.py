...
def logger(path):
    def __logger(old_function):
        def new_function(*args, **kwargs):
            ...
            log_entry = (
                f"{call_time} - Function: {function_name}\n"
...
student1.grades = {'Python': [8, 8, 9], 'Git': [9, 9]}

student2 = Student('Анастасия', 'Младинская', 'женский')
student2.courses_in_progress += ['Python']
student2.finished_courses += ['Git']
student2.grades = {'Python': [10, 9, 8], 'Git': [10, 9]}

lecturer1 = Lecturer('Дмитрий', 'Демидов')
lecturer1.courses_attached += ['Python']
lecturer1.grades = {'Python': [9, 10, 10]}

lecturer2 = Lecturer('Павел', 'Молибог')
lecturer2.courses_attached += ['Python']
lecturer2.grades = {'Python': [10, 10, 9]}

reviewer1 = Reviewer('Александр', 'Нестеров')
reviewer1.courses_attached += ['Python']

reviewer2 = Reviewer('Алена', 'Батицкая')
